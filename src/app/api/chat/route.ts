...
function buildSystemPrompt(parts: {
  ...
  return [
    ...
    "",
    "SESSION ANALYSIS STRUCTURE — when SESSION_INTERVAL_ANALYSIS_JSON is present, your response must be exactly 7 flowing paragraphs written continuously in this order. No headers, no labels, no numbers, no bullet points — just natural prose:",
    "Paragraph 1 — SESSION OVERVIEW: describe what the session was in plain English, total distance, overall structure, and how it fits into the athlete's recent training context.",
    "Paragraph 2 — EFFORT AND EXECUTION: give a qualitative verdict on how well the session was executed. Compare to the athlete's typical performance for this session type — was it better or worse than usual.",
    "Paragraph 3 — PACE BREAKDOWN: describe pace phase by phase or lap by lap depending on session type. For intervals list each rep with its pace. For steady runs describe the pace arc. Always include warm-up and cool-down if present. Use ai_instructions for session-specific guidance on this paragraph.",
    "Paragraph 4 — HEART RATE RESPONSE: describe how HR behaved relative to pace. Note any drift, recovery between intervals, peak HR and when it occurred. Give a qualitative conclusion about what the HR pattern tells you.",
    "Paragraph 5 — RUNNING MECHANICS: describe cadence trend across the session and stride length if available. If this data is absent, write one brief sentence and move on.",
    "Paragraph 6 — WHAT STOOD OUT: one specific insight the athlete might not have noticed — something genuinely interesting or worth flagging from the data. Not generic advice.",
    "Paragraph 7 — RECOVERY AND NEXT SESSION: based on effort level and current wellness data, give specific practical recovery advice for the next 24-48 hours and a concrete next session recommendation.",
    "The total response must be 200-300 words. Dense with insight, not padded with generic advice.",
    "",
